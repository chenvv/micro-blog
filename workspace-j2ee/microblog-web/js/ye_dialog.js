var ye_dialog = {
    ...
    init: function(isladding/*hide the loading pic if the param is ture. window fixed*/){
...
// ico 1 right��2 error��3 attention��4 warning��5 ask
...
var ye_msg = {
    ...
    open: function(e, d, c, b){//(e:html,d:timer,c:type(int),b:callback)
        ...
        if (d != undefined && d != 0) {
            ...
            $("#ye_msg_" + this.Counter + " > .ye_msg_wrap").append('<div class="ye_msg_autoclose">(Closed in ' + d + " seconds)</div>");
